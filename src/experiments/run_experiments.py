...
def run_all_experiments(csv_path):
    ...
    # Load and preprocess
    X_train, y_train, X_test, y_test = load_dataset(csv_path)
    ...
    experiments = [
        ...
        {"model_class": LogisticRegressionModel, "ngram_range": (1,3), "name": "Logistic Regression"},
        # Naive Bayes
        ...
        {"model_class": SVMModel, "ngram_range": (1,3), "name": "SVM"},
        # Tree-based models
